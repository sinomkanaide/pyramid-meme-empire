...
const runMigrations = async () => {
  ...
  const migrations = [
    ...
    // Update metadata if quest already exists but missing reward_label/base_completions
    `UPDATE quests SET requirement_metadata = '{"url": "", "reward_label": "1 GIGA ticket", "base_completions": 18}' WHERE title = 'MetaSpace Partnership' AND (requirement_metadata->>'reward_label' IS NULL)`,
  ];
